...
class Game{
 ...
 //    }
	...
	onMouseDown( event ) {
		console.log("onMouseDown event called");
	...
	animate() {
		...
		if (this.cameras!=undefined && this.cameras.active!=undefined && this.player!==undefined && this.player.object!==undefined){
			...
			// this.dolly.lookAt(pos);
			// 			console.log("camera nd dolly pos");
    ...
    handleController( controller, dt ){
        ...
        if (controller.userData.selectPressed ){
            ...
            // this.player.object.position.set(this.dolly.position.x, 0, this.dolly.position.z - 100);
			...
			// this.player.object.rotation.set(this.dolly.rotation.x, this.dolly.rotation.y, this.dolly.rotation.z);
			// this.player.object.rotation.set(0, 2.6, 0);
...
// the following line extracts the position, rotation and scale in world space
			...
			// this.camera.matrixWorld.decompose( position, rotation, scale );
